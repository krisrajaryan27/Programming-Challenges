...
/**
 * <a href="http://www.geeksforgeeks.org/add-two-bit-strings/">...</a>
 * <a href="http://www.geeksforgeeks.org/binary-representation-of-a-given-number/">...</a>
 * <a href="http://www.geeksforgeeks.org/add-two-numbers-without-using-arithmetic-operators/">...</a>
 */
public class AddTwoNumbers {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(addTwoNumbersWithoutArithmeticOperator(296, 5662));
        System.out.println(addTwoNumbersWithoutArithmeticOperatorFaster(296, 5662));
        printResult(result);
    }
    ...
    public static int addTwoNumbersWithoutArithmeticOperator(int num1, int num2) {
        int carry = 0;
        int result = 0;
        for (int i = 0; i <= 31; i++) {
